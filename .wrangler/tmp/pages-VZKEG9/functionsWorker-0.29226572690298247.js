...
var onRequest = /* @__PURE__ */ __name(async (context) => {
  ...
  if (hostname.includes("emergencycontractors.net")) {
    ...
    const isStaticAsset = staticExtensions.some((ext) => path.toLowerCase().endsWith(ext)) || path.includes("/assets/") || path.includes("/images/") || path.includes("/blog/") || path.includes("/cdn-cgi/");
    if (isStaticAsset) {
      return context.next();
    }
...
// ../.wrangler/tmp/pages-VZKEG9/functionsRoutes-0.607406801164238.mjs
var routes = [
  {
    routePath: "/",
    mountPath: "/",
