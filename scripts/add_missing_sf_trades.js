...
const currentData = fs.readFileSync(TARGET_FILE, 'utf-8');
...
console.log(`\n📊 Current SF data: ${existingData.length} listings`);

// Group by trade to see what we have
const byTrade = {};
...
// Only add what's missing (breakdown, and fill gaps in drain-specialist and glazier)
const towData = [
...
// Combine new data (ONLY adding, not trimming)
const allNewData = [
