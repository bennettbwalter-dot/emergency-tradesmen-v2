...
const cities = [
    { name: 'Birmingham', state: 'AL', filePrefix: 'birmingham_al' }
];

const trades = ['plumber', 'electrician', 'locksmith', 'hvac'];

async function importData() {
    console.log('Starting Birmingham, AL import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Birmingham, AL: ${totalImported} listings`);
}
