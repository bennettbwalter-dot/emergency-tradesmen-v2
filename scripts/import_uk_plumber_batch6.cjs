...
const batch6Cities = [
    ...
    { name: 'St Helens', lat: 53.4543, lng: -2.7303 },
    { name: 'Crawley', lat: 51.1132, lng: -0.1831 },
    { name: 'Basildon', lat: 51.5724, lng: 0.4571 },
    { name: 'Cheltenham', lat: 51.8995, lng: -2.0711 },
    { name: 'Gillingham', lat: 51.3851, lng: 0.5483 },
    { name: 'Worthing', lat: 50.8147, lng: -0.3714 },
    { name: 'Rochdale', lat: 53.6150, lng: -2.1554 },
    { name: 'Southend-on-Sea', lat: 51.5413, lng: 0.7126 }
];
...
importBatch().then(() => console.log('Batch 6 UK Plumber Import Complete'));
