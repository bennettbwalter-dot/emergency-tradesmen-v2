...
const cities = [
    { name: 'Miami Beach', state: 'FL', filePrefix: 'miamibeach_fl' },
    { name: 'Doral', state: 'FL', filePrefix: 'doral_fl' },
    { name: 'Coral Gables', state: 'FL', filePrefix: 'coralgables_fl' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Miami Suburbs (Miami Beach, Doral, Coral Gables) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Miami Suburbs: ${totalImported} listings`);
}
