...
const ukWaterRestorationCitiesBatch5 = [
    { name: "Gloucester", lat: 51.8642, lng: -2.2448 },
    { name: "Rotherham", lat: 53.4308, lng: -1.3568 },
    ...
    { name: "Maidstone", lat: 51.2720, lng: 0.5287 },
    { name: "Blackburn", lat: 53.7480, lng: -2.4820 },
    { name: "Basildon", lat: 51.5761, lng: 0.4887 },
    { name: "Chelmsford", lat: 51.7356, lng: 0.4687 }
];

importUKTradeData(ukWaterRestorationCitiesBatch5, 'water-restoration');
