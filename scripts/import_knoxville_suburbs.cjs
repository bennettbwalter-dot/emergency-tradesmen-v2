...
const cities = [
    { name: 'Maryville', state: 'TN', filePrefix: 'maryville_tn' },
    { name: 'Oak Ridge', state: 'TN', filePrefix: 'oakridge_tn' },
    { name: 'Sevierville', state: 'TN', filePrefix: 'sevierville_tn' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Knoxville Suburbs (Maryville, Oak Ridge, Sevierville) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Knoxville Suburbs: ${totalImported} listings`);
}
