...
const ukHVACCitiesBatch6 = [
    { name: "Worthing", lat: 50.8166, lng: -0.3724 },
    { name: "Telford", lat: 52.6784, lng: -2.4453 },
    { name: "Crawley", lat: 51.1142, lng: -0.1831 },
    { name: "Bedford", lat: 52.1360, lng: -0.4666 },
    { name: "Gillingham", lat: 51.3789, lng: 0.5511 },
    { name: "Birkenhead", lat: 53.3934, lng: -3.0147 },
    { name: "Tamworth", lat: 52.6339, lng: -1.6959 },
    { name: "Eastbourne", lat: 50.7680, lng: 0.2845 },
    { name: "Grays", lat: 51.4746, lng: 0.3291 },
    { name: "St Albans", lat: 51.7528, lng: -0.3394 }
];

importUKTradeData(ukHVACCitiesBatch6, 'hvac');
