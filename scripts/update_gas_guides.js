...
async function updatePosts() {
    const gbContent = fs.readFileSync('scripts/expanded_gas_guide_gb.md', 'utf8');
    const usContent = fs.readFileSync('scripts/expanded_gas_guide_us.md', 'utf8');
    ...
    const { error: gbError } = await supabase
        ...
        .eq('slug', 'smell-gas-what-to-do-safety-protocol-gb');
    ...
    const { error: usError } = await supabase
        ...
        .eq('slug', 'smell-gas-what-to-do-safety-protocol-us');
