...
const cities = [
    { name: 'Norfolk', state: 'VA', filePrefix: 'norfolk_va' },
    { name: 'Chesapeake', state: 'VA', filePrefix: 'chesapeake_va' },
    { name: 'Hampton', state: 'VA', filePrefix: 'hampton_va' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Virginia Beach Suburbs (Norfolk, Chesapeake, Hampton) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Virginia Beach Suburbs: ${totalImported} listings`);
}
