...
const getReq = https.request({
    ...
    res.on('end', () => {
        ...
        const amazonMatch = content.match(/<div class="amazon-product-section">[\s\S]{1,500}/);
        if (amazonMatch) {
            console.log('Amazon section found:');
            console.log(amazonMatch[0]);
        } else {
            console.log('Amazon section not found');
        }
    });
});
