...
const cities = [
    { name: 'Jackson', state: 'MS', prefix: 'jackson_ms' }
];
...
async function importJackson() {
    console.log('Starting Phase 28 (Jackson) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Phase 28 (Jackson): ${totalImported} listings`);
}
