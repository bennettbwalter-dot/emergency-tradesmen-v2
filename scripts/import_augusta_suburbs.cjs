...
const cities = [
    { name: 'Evans', state: 'GA', filePrefix: 'evans_ga' },
    { name: 'Martinez', state: 'GA', filePrefix: 'martinez_ga' },
    { name: 'Grovetown', state: 'GA', filePrefix: 'grovetown_ga' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Augusta Suburbs (Evans, Martinez, Grovetown) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Augusta Suburbs: ${totalImported} listings`);
}
