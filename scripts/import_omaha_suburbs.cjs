...
const cities = [
    { name: 'Bellevue', state: 'NE', filePrefix: 'bellevue_ne' },
    { name: 'Papillion', state: 'NE', filePrefix: 'papillion_ne' },
    { name: 'La Vista', state: 'NE', filePrefix: 'lavista_ne' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Omaha Suburbs (Bellevue, Papillion, La Vista) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Omaha Suburbs: ${totalImported} listings`);
}
