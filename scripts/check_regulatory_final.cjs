...
const getReq = https.request({
    ...
    res.on('end', () => {
        ...
        // Find regulatory section and show everything after it
        ...
        if (regulatoryIndex > -1) {
            ...
            console.log('After REGULATORY AUTHORITIES:');
            console.log(afterRegulatory);
        } else {
            console.log('Regulatory section not found');
        }
    });
});
