...
const cities = [
    { name: 'Gresham', state: 'OR', filePrefix: 'gresham_or' },
    { name: 'Hillsboro', state: 'OR', filePrefix: 'hillsboro_or' },
    { name: 'Beaverton', state: 'OR', filePrefix: 'beaverton_or' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Portland Suburbs (Gresham, Hillsboro, Beaverton) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Portland Suburbs: ${totalImported} listings`);
}
