...
const cities = [
    { name: 'Franklin', state: 'TN', filePrefix: 'franklin_tn' },
    { name: 'Brentwood', state: 'TN', filePrefix: 'brentwood_tn' },
    { name: 'Murfreesboro', state: 'TN', filePrefix: 'murfreesboro_tn' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Nashville Suburbs (Franklin, Brentwood, Murfreesboro) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Nashville Suburbs: ${totalImported} listings`);
}
