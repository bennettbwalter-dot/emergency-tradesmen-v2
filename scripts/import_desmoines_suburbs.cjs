...
const cities = [
    { name: 'Ankeny', state: 'IA', filePrefix: 'ankeny_ia' },
    { name: 'West Des Moines', state: 'IA', filePrefix: 'westdesmoines_ia' },
    { name: 'Urbandale', state: 'IA', filePrefix: 'urbandale_ia' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Des Moines (IA) Suburbs (Ankeny, West Des Moines, Urbandale) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Des Moines (IA) Suburbs: ${totalImported} listings`);
}
