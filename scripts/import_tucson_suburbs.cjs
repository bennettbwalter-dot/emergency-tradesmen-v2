...
const cities = [
    { name: 'Oro Valley', state: 'AZ', filePrefix: 'orovalley_az' },
    { name: 'Marana', state: 'AZ', filePrefix: 'marana_az' },
    { name: 'Sahuarita', state: 'AZ', filePrefix: 'sahuarita_az' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Tucson Suburbs (Oro Valley, Marana, Sahuarita) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Tucson Suburbs: ${totalImported} listings`);
}
