...
const files = [
    'denver_glass_real.json',
    'washingtondc_glass_real.json',
    'boston_glass_real.json',
    'elpaso_glass_real.json',
    'nashville_glass_real.json',
    'oklahomacity_glass_real.json'
];

async function importGlassRepair() {
    console.log('🚀 Starting Phase 8 Batch 4: Emergency Glass Repair Import...');
    ...
    for (const file of files) {
        ...
        const cityMapping = {
            'denver_glass_real.json': 'Denver',
            'washingtondc_glass_real.json': 'Washington DC',
            'boston_glass_real.json': 'Boston',
            'elpaso_glass_real.json': 'El Paso',
            'nashville_glass_real.json': 'Nashville',
            'oklahomacity_glass_real.json': 'Oklahoma City'
        };
    ...
    console.log('✅ Phase 8 Batch 4 Import Complete!');
}
