...
# Source Data
source_file = r"C:\Users\Nick\Downloads\hitmaker-2026\emergency-tradesmen\scripts\verified_phase24_batch2.json"
with open(source_file, 'r', encoding='utf-8') as f:
    data = json.load(f)

print(f"Loaded {len(data)} listings for Batch 2 Import.")

for item in data:
    # 1. Check Duplicate (Phone)
    # Refined Check: Phone + Trade
