...
const batch5Cities = [
    ...
    { name: 'Newport', lat: 51.5830, lng: -2.9970 },
    { name: 'Preston', lat: 53.7632, lng: -2.7031 },
    { name: 'Slough', lat: 51.5085, lng: -0.5918 },
    { name: 'Rotherham', lat: 53.4300, lng: -1.3570 },
    { name: 'West Bromwich', lat: 52.5190, lng: -1.9950 },
...
importBatch().then(() => console.log('Batch 5 Builder Import Complete'));
