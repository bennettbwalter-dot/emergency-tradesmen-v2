...
const cities = [
    { name: 'St. Matthews', state: 'KY', filePrefix: 'stmatthews_ky' },
    { name: 'Jeffersontown', state: 'KY', filePrefix: 'jeffersontown_ky' },
    { name: 'Shively', state: 'KY', filePrefix: 'shively_ky' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Louisville Suburbs (St. Matthews, Jeffersontown, Shively) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Louisville Suburbs: ${totalImported} listings`);
}
