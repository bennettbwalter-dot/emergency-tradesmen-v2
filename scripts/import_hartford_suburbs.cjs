...
const cities = [
    { name: 'New Britain', state: 'CT', filePrefix: 'newbritain_ct' },
    { name: 'West Hartford', state: 'CT', filePrefix: 'westhartford_ct' },
    { name: 'Bristol', state: 'CT', filePrefix: 'bristol_ct' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Hartford Suburbs (New Britain, West Hartford, Bristol) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Hartford Suburbs: ${totalImported} listings`);
}
