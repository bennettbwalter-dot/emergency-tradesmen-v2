...
const cities = [
    { name: 'Little Rock', state: 'AR', prefix: 'little_rock_ar' }
];
...
async function importLittleRock() {
    console.log('Starting Phase 27 (Little Rock) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Phase 27 (Little Rock): ${totalImported} listings`);
}
