...
const cities = [
    { name: 'Barboursville', state: 'WV', filePrefix: 'barboursville_wv' },
    { name: 'Milton', state: 'WV', filePrefix: 'milton_wv' },
    { name: 'Kenova', state: 'WV', filePrefix: 'kenova_wv' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Huntington Suburbs (Barboursville, Milton, Kenova) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Huntington Suburbs: ${totalImported} listings`);
}
