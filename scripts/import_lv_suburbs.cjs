...
const cities = [
    { name: 'Henderson', state: 'NV', filePrefix: 'henderson_nv' },
    { name: 'Summerlin', state: 'NV', filePrefix: 'summerlin_nv' },
    { name: 'Spring Valley', state: 'NV', filePrefix: 'springvalley_nv' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Las Vegas Suburbs (Henderson, Summerlin, Spring Valley) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Las Vegas Suburbs: ${totalImported} listings`);
}
