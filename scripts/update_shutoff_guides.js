...
async function updatePosts() {
    const gbContent = fs.readFileSync('scripts/expanded_shutoff_guide_gb.md', 'utf8');
    const usContent = fs.readFileSync('scripts/expanded_shutoff_guide_us.md', 'utf8');
    ...
    const { error: gbError } = await supabase
        ...
        .eq('slug', 'home-emergency-stopcock-fusebox-gb');
    ...
    const { error: usError } = await supabase
        ...
        .eq('slug', 'home-emergency-shut-off-protocol-us');
