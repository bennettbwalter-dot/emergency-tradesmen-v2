...
const cities = [
    { name: 'Dublin', state: 'OH', filePrefix: 'dublin_oh' },
    { name: 'Westerville', state: 'OH', filePrefix: 'westerville_oh' },
    { name: 'Grove City', state: 'OH', filePrefix: 'grovecity_oh' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Columbus Suburbs (Dublin, Westerville, Grove City) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Columbus Suburbs: ${totalImported} listings`);
}
