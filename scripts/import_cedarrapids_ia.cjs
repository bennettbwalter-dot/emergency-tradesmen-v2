...
const cities = [
    { name: 'Cedar Rapids', state: 'IA', filePrefix: 'cedarrapids_ia' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Cedar Rapids, IA import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Cedar Rapids, IA: ${totalImported} listings`);
}
