...
const cities = [
    { name: 'Meridian', state: 'ID', filePrefix: 'meridian_id' },
    { name: 'Nampa', state: 'ID', filePrefix: 'nampa_id' },
    { name: 'Eagle', state: 'ID', filePrefix: 'eagle_id' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Boise Suburbs (Meridian, Nampa, Eagle) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Boise Suburbs: ${totalImported} listings`);
}
