...
const cities = [
    { name: 'Kaneohe', state: 'HI', filePrefix: 'kaneohe_hi' },
    { name: 'Kailua', state: 'HI', filePrefix: 'kailua_hi' },
    { name: 'Waipahu', state: 'HI', filePrefix: 'waipahu_hi' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Honolulu Suburbs (Kaneohe, Kailua, Waipahu) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Honolulu Suburbs: ${totalImported} listings`);
}
