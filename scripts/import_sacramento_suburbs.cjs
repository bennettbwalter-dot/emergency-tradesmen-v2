...
const cities = [
    { name: 'Elk Grove', state: 'CA', filePrefix: 'elkgrove_ca' },
    { name: 'Roseville', state: 'CA', filePrefix: 'roseville_ca' },
    { name: 'Folsom', state: 'CA', filePrefix: 'folsom_ca' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Sacramento Suburbs (Elk Grove, Roseville, Folsom) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Sacramento Suburbs: ${totalImported} listings`);
}
