...
const batch9Cities = [
    { name: 'Gravesend', lat: 51.4419, lng: 0.3675 },
    { name: 'Rochester', lat: 51.3853, lng: 0.5058 },
    { name: 'Chatham', lat: 51.3791, lng: 0.5284 },
    { name: 'Sittingbourne', lat: 51.3411, lng: 0.7408 },
    { name: 'Faversham', lat: 51.3149, lng: 0.8891 },
    { name: 'Canterbury', lat: 51.2802, lng: 1.0789 },
    { name: 'Margate', lat: 51.3811, lng: 1.3861 },
    { name: 'Ramsgate', lat: 51.3343, lng: 1.4162 },
    { name: 'Dover', lat: 51.1279, lng: 1.3134 },
    { name: 'Folkestone', lat: 51.0814, lng: 1.1772 }
];
...
importBatch().then(() => console.log('Batch 9 UK Plumber Import Complete'));
