...
const cities = [
    { name: 'Wichita', state: 'KS', prefix: 'wichita_ks' }
];
...
async function importWichita() {
    console.log('Starting Phase 26 (Wichita) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Phase 26 (Wichita): ${totalImported} listings`);
}
