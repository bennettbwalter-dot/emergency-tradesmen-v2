...
const cities = [
    { name: 'Naperville', state: 'IL', filePrefix: 'naperville_il' },
    { name: 'Evanston', state: 'IL', filePrefix: 'evanston_il' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Chicago Suburbs (Naperville, Evanston) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Chicago Suburbs: ${totalImported} listings`);
}
