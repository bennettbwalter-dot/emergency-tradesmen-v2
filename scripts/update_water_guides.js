...
async function updatePosts() {
    const gbContent = fs.readFileSync('scripts/expanded_water_guide_gb.md', 'utf8');
    const usContent = fs.readFileSync('scripts/expanded_water_guide_us.md', 'utf8');
    ...
    const { error: gbError } = await supabase
        ...
        .eq('slug', 'water-damage-restoration-strip-out-gb');
    ...
    const { error: usError } = await supabase
        ...
        .eq('slug', 'water-damage-restoration-category-mold-us');
