...
const getReq = https.request({
    ...
    res.on('end', () => {
        ...
        // Replace with a test image from picsum
        const oldImg = 'src="/images/blog/generated/portable-power-stations.png"';
        const newImg = 'src="https://picsum.photos/280/280"';
        
        if (content.includes(oldImg)) {
            content = content.replace(oldImg, newImg);
            console.log('Replaced with test image');
