...
const cities = [
    { name: 'Shrewsbury', state: 'MA', filePrefix: 'shrewsbury_ma' },
    { name: 'Auburn', state: 'MA', filePrefix: 'auburn_ma' },
    { name: 'Holden', state: 'MA', filePrefix: 'holden_ma' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Worcester Suburbs (Shrewsbury, Auburn, Holden) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Worcester Suburbs: ${totalImported} listings`);
}
