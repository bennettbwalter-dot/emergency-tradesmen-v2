...
const cities = [
    { name: 'Brandon', state: 'FL', filePrefix: 'brandon_fl' },
    { name: 'Riverview', state: 'FL', filePrefix: 'riverview_fl' },
    { name: 'Valrico', state: 'FL', filePrefix: 'valrico_fl' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Tampa Suburbs (Brandon, Riverview, Valrico) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Tampa Suburbs: ${totalImported} listings`);
}
