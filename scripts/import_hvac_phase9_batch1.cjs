...
async function importData() {
    console.log(`🚀 Starting Phase 9 Batch 1 HVAC Import...`);
    ...
    for (const city of cities) {
        ...
        for (const business of data) {
            // Generate slug - adding trade to avoid collisions with gas-engineer
    ...
    console.log('✨ Batch 1 HVAC Import Complete!');
}
