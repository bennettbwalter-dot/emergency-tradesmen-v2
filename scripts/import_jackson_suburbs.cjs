...
const cities = [
    { name: 'Clinton', state: 'MS', filePrefix: 'clinton_ms' },
    { name: 'Madison', state: 'MS', filePrefix: 'madison_ms' },
    { name: 'Ridgeland', state: 'MS', filePrefix: 'ridgeland_ms' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Jackson Suburbs (Clinton, Madison, Ridgeland) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Jackson Suburbs: ${totalImported} listings`);
}
