...
const cities = [
    { name: 'Santa Monica', state: 'CA', filePrefix: 'santamonica_ca' },
    { name: 'Pasadena', state: 'CA', filePrefix: 'pasadena_ca' },
    { name: 'Long Beach', state: 'CA', filePrefix: 'longbeach_ca' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Los Angeles Suburbs (Santa Monica, Pasadena, Long Beach) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Los Angeles Suburbs: ${totalImported} listings`);
}
