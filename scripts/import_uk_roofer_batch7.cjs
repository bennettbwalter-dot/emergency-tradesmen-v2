...
const batch7Cities = [
    { name: 'Woking', lat: 51.319, lng: -0.5584 },
    { name: 'Lincoln', lat: 53.2268, lng: -0.5378 },
    { name: 'Chelmsford', lat: 51.7356, lng: 0.4678 },
    { name: 'Maidstone', lat: 51.272, lng: 0.523 },
    { name: 'Basingstoke', lat: 51.2625, lng: -1.087 },
    { name: 'Worcester', lat: 52.1936, lng: -2.2215 },
    { name: 'Beeston', lat: 52.927, lng: -1.215 },
    { name: 'Eastleigh', lat: 50.9631, lng: -1.3533 },
    { name: 'Hastings', lat: 50.8542, lng: 0.5734 },
    { name: 'Eastbourne', lat: 50.768, lng: 0.285 }
];
...
importBatch().then(() => console.log('Batch 7 UK Roofer Import Complete'));
