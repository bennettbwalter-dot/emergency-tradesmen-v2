...
const cities = [
    { name: 'Prichard', state: 'AL', filePrefix: 'prichard_al' },
    { name: 'Saraland', state: 'AL', filePrefix: 'saraland_al' },
    { name: 'Tillmans Corner', state: 'AL', filePrefix: 'tillmanscorner_al' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Mobile Suburbs (Prichard, Saraland, Tillmans Corner) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Mobile Suburbs: ${totalImported} listings`);
}
