...
const cities = [
    { name: 'Oakland', state: 'CA', filePrefix: 'oakland_ca' },
    { name: 'Berkeley', state: 'CA', filePrefix: 'berkeley_ca' },
    { name: 'San Jose', state: 'CA', filePrefix: 'sanjose_ca' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting San Francisco Suburbs (Oakland, Berkeley, San Jose) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for San Francisco Suburbs: ${totalImported} listings`);
}
