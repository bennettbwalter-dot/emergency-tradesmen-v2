...
const cities = [
    { name: 'Des Moines', state: 'IA', prefix: 'des_moines_ia' }
];
...
async function importDesMoines() {
    console.log('Starting Phase 27 (Des Moines) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Phase 27 (Des Moines): ${totalImported} listings`);
}
