...
async function updatePosts() {
    const gbContent = fs.readFileSync('scripts/expanded_roof_guide_gb.md', 'utf8');
    const usContent = fs.readFileSync('scripts/expanded_roof_guide_us.md', 'utf8');
    ...
    const { error: gbError } = await supabase
        ...
        .eq('slug', 'emergency-roof-leak-tarping-gb');
    ...
    const { error: usError } = await supabase
        ...
        .eq('slug', 'emergency-roof-leak-tarping-us');
