/**
 * Update hero image for smart-leak-detection-us
 */
...
async function main() {
    const post = await fetchPost('smart-leak-detection-us');
    if (!post) {
    ...
    const newCoverImage = '/images/blog/generated/smart-leak-detection-us-hero.png';
