...
async function updatePosts() {
    const gbContent = fs.readFileSync('scripts/expanded_sewage_guide_gb.md', 'utf8');
    const usContent = fs.readFileSync('scripts/expanded_sewage_guide_us.md', 'utf8');
    ...
    const { error: gbError } = await supabase
        ...
        .eq('slug', 'drain-smell-bathroom-soil-stack-gb');
    ...
    const { error: usError } = await supabase
        ...
        .eq('slug', 'sewage-smell-in-house-p-trap-us');
