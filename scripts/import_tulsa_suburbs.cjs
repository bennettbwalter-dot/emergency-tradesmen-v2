...
const cities = [
    { name: 'Broken Arrow', state: 'OK', filePrefix: 'brokenarrow_ok' },
    { name: 'Owasso', state: 'OK', filePrefix: 'owasso_ok' },
    { name: 'Jenks', state: 'OK', filePrefix: 'jenks_ok' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Tulsa Suburbs (Broken Arrow, Owasso, Jenks) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Tulsa Suburbs: ${totalImported} listings`);
}
