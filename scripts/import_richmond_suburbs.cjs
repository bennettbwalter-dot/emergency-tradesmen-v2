...
const cities = [
    { name: 'San Pablo', state: 'CA', filePrefix: 'sanpablo_ca' },
    { name: 'El Cerrito', state: 'CA', filePrefix: 'elcerrito_ca' },
    { name: 'Pinole', state: 'CA', filePrefix: 'pinole_ca' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Richmond Suburbs (San Pablo, El Cerrito, Pinole) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Richmond Suburbs: ${totalImported} listings`);
}
