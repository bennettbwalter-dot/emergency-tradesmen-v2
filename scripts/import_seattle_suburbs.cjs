...
const cities = [
    { name: 'Bellevue', state: 'WA', filePrefix: 'bellevue_wa' },
    { name: 'Redmond', state: 'WA', filePrefix: 'redmond_wa' },
    { name: 'Kirkland', state: 'WA', filePrefix: 'kirkland_wa' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Seattle Suburbs (Bellevue, Redmond, Kirkland) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Seattle Suburbs: ${totalImported} listings`);
}
