...
const posts = [
    {
        blogPath: 'c:/Users/Nick/OneDrive/protection/OneDrive/content-assistant/brain/memory/allmemories/blog_day31_fuse_box_guide.md',
        slug: 'is-your-fuse-box-up-to-code-consumer-unit-guide',
        title: 'Is Your Fuse Box Up to Code? The 2026 Homeowner’s Guide to Consumer Units and RCD Safety',
        excerpt: 'Your fuse box is the heart of your electrical system. Is it up to 2026 code? Learn about RCDs, AFDDs, and when to call a pro.',
        cover_image: '/blog/fuse_box_guide_cover.png',
        published_at: new Date('2026-03-10').toISOString()
    },
    {
        blogPath: 'c:/Users/Nick/OneDrive/protection/OneDrive/content-assistant/brain/memory/allmemories/blog_day32_running_toilet_fix.md',
        slug: 'toilet-wont-stop-running-five-minute-fix',
        title: 'Toilet Won’t Stop Running? The 2026 Emergency Guide to the 5-Minute Fix',
        excerpt: 'A running toilet can waste 750 litres per day! Learn the 5-minute fix to save water and money before calling an emergency plumber in 2026.',
        cover_image: '/blog/running_toilet_fix_cover.png',
...
async function uploadPosts() {
    for (const post of posts) {
        ...
        if (error) console.error(`Error upserting ${post.slug}:`, error);
