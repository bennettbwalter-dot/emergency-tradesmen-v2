...
const batch6Cities = [
    ...
    { name: 'Oldham', lat: 53.5409, lng: -2.1124 },
    { name: 'St Helens', lat: 53.4541, lng: -2.7308 },
    { name: 'Crawley', lat: 51.1132, lng: -0.1831 },
    { name: 'Basildon', lat: 51.5761, lng: 0.4887 },
    { name: 'Cheltenham', lat: 51.8995, lng: -2.0782 },
    { name: 'Gillingham', lat: 51.3850, lng: 0.5501 },
    { name: 'Worthing', lat: 50.8147, lng: -0.3714 },
    { name: 'Rochdale', lat: 53.6190, lng: -2.1580 },
...
importBatch().then(() => console.log('Batch 6 Builder Import Complete'));
