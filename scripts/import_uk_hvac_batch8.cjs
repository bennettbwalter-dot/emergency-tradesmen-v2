...
const ukHVACCitiesBatch8 = [
    { name: "Mansfield", lat: 53.1424, lng: -1.1983 },
    { name: "Carlisle", lat: 54.8925, lng: -2.9329 },
    { name: "Redditch", lat: 52.3072, lng: -1.9427 },
    { name: "Harrogate", lat: 53.9921, lng: -1.5418 },
    { name: "Woking", lat: 51.3190, lng: -0.5589 },
    { name: "Stourbridge", lat: 52.4552, lng: -2.1472 },
    { name: "South Shields", lat: 54.9961, lng: -1.4310 },
    { name: "Stevenage", lat: 51.9017, lng: -0.2019 },
    { name: "Burton-upon-Trent", lat: 52.8019, lng: -1.6367 },
    { name: "Beeston", lat: 52.9268, lng: -1.2162 }
];

importUKTradeData(ukHVACCitiesBatch8, 'hvac');
