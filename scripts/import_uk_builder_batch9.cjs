...
const batch9Cities = [
    ...
    { name: 'Chatham', lat: 51.3791, lng: 0.5235 },
    { name: 'Sittingbourne', lat: 51.3390, lng: 0.7390 },
    { name: 'Faversham', lat: 51.3130, lng: 0.8930 },
    { name: 'Canterbury', lat: 51.2800, lng: 1.0800 },
    { name: 'Margate', lat: 51.3860, lng: 1.3830 },
    { name: 'Ramsgate', lat: 51.3360, lng: 1.4170 },
    { name: 'Dover', lat: 51.1270, lng: 1.3130 },
    { name: 'Folkestone', lat: 51.0810, lng: 1.1780 }
];
...
importBatch().then(() => console.log('Batch 9 Builder Import Complete'));
