...
const batch6Cities = [
    { name: 'Colchester', lat: 51.8959, lng: 0.8918 },
    { name: 'Oldham', lat: 53.5409, lng: -2.1114 },
    { name: 'St Helens', lat: 53.4543, lng: -2.7307 },
    { name: 'Crawley', lat: 51.1132, lng: -0.1831 },
    { name: 'Basildon', lat: 51.5761, lng: 0.4887 },
    { name: 'Cheltenham', lat: 51.8995, lng: -2.0711 },
    { name: 'Gillingham', lat: 51.385, lng: 0.5471 },
    { name: 'Worthing', lat: 50.8147, lng: -0.3714 },
    { name: 'Rochdale', lat: 53.6149, lng: -2.1557 },
    { name: 'Southend-on-Sea', lat: 51.5389, lng: 0.7128 }
];
...
importBatch().then(() => console.log('Batch 6 UK Roofer Import Complete'));
