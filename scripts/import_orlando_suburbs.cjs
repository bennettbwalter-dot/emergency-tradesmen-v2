...
const cities = [
    { name: 'Kissimmee', state: 'FL', filePrefix: 'kissimmee_fl' },
    { name: 'Sanford', state: 'FL', filePrefix: 'sanford_fl' },
    { name: 'Altamonte Springs', state: 'FL', filePrefix: 'altamontesprings_fl' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Orlando Suburbs (Kissimmee, Sanford, Altamonte Springs) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Orlando Suburbs: ${totalImported} listings`);
}
