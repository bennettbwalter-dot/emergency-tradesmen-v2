...
const cities = [
    { name: 'Bloomington', state: 'MN', filePrefix: 'bloomington_mn' },
    { name: 'Brooklyn Park', state: 'MN', filePrefix: 'brooklynpark_mn' },
    { name: 'Plymouth', state: 'MN', filePrefix: 'plymouth_mn' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Minneapolis Suburbs (Bloomington, Brooklyn Park, Plymouth) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Minneapolis Suburbs: ${totalImported} listings`);
}
