...
const cities = [
    { name: 'West Valley City', state: 'UT', filePrefix: 'westvalleycity_ut' },
    { name: 'West Jordan', state: 'UT', filePrefix: 'westjordan_ut' },
    { name: 'Sandy', state: 'UT', filePrefix: 'sandy_ut' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Salt Lake City Suburbs (West Valley City, West Jordan, Sandy) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Salt Lake City Suburbs: ${totalImported} listings`);
}
