...
const cities = [
    { name: 'Spokane Valley', state: 'WA', filePrefix: 'spokanevalley_wa' },
    { name: 'Liberty Lake', state: 'WA', filePrefix: 'libertylake_wa' },
    { name: 'Cheney', state: 'WA', filePrefix: 'cheney_wa' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Spokane Suburbs (Spokane Valley, Liberty Lake, Cheney) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Spokane Suburbs: ${totalImported} listings`);
}
