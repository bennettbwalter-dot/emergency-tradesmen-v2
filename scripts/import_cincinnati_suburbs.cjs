...
const cities = [
    { name: 'Hamilton', state: 'OH', filePrefix: 'hamilton_oh' },
    { name: 'Fairfield', state: 'OH', filePrefix: 'fairfield_oh' },
    { name: 'Mason', state: 'OH', filePrefix: 'mason_oh' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Cincinnati Suburbs (Hamilton, Fairfield, Mason) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Cincinnati Suburbs: ${totalImported} listings`);
}
