...
const batch3Cities = [
    ...
    { name: 'Reading', lat: 51.4543, lng: -0.9701 },
    { name: 'Brighton', lat: 50.8225, lng: -0.1372 },
    { name: 'Portsmouth', lat: 50.7989, lng: -1.0912 },
    ...
    { name: 'Peterborough', lat: 52.5739, lng: -0.2431 },
...
importBatch().then(() => console.log('Batch 3 Breakdown Recovery Import Complete'));
