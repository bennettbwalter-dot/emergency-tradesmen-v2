...
const cities = [
    { name: 'Hixson', state: 'TN', filePrefix: 'hixson_tn' },
    { name: 'East Brainerd', state: 'TN', filePrefix: 'eastbrainerd_tn' },
    { name: 'Red Bank', state: 'TN', filePrefix: 'redbank_tn' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Chattanooga Suburbs (Hixson, East Brainerd, Red Bank) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Chattanooga Suburbs: ${totalImported} listings`);
}
