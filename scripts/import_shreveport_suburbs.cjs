...
const cities = [
    { name: 'Bossier City', state: 'LA', filePrefix: 'bossiercity_la' },
    { name: 'Benton', state: 'LA', filePrefix: 'benton_la' },
...
async function importData() {
    console.log('Starting Shreveport Suburbs (Bossier City, Benton, Haughton) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Shreveport Suburbs: ${totalImported} listings`);
}
