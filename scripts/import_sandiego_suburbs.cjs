...
const cities = [
    { name: 'Chula Vista', state: 'CA', filePrefix: 'chulavista_ca' },
    { name: 'Oceanside', state: 'CA', filePrefix: 'oceanside_ca' },
    { name: 'Escondido', state: 'CA', filePrefix: 'escondido_ca' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting San Diego Suburbs (Chula Vista, Oceanside, Escondido) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for San Diego Suburbs: ${totalImported} listings`);
}
