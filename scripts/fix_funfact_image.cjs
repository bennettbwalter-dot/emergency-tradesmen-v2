...
const getReq = https.request({
    ...
    res.on('end', () => {
        ...
        // Replace Fun Fact image from 2 to 1
        const oldImg = '/images/blog/generated/portable-power-stations-2.jpg';
        const newImg = '/images/blog/generated/portable-power-stations-1.png';
        
        if (content.includes(oldImg)) {
            content = content.replace(oldImg, newImg);
            console.log('Replaced Fun Fact image with Portable Power Stations 1');
