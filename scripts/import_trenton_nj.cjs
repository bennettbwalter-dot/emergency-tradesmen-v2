...
const cities = [
    { name: 'Trenton', state: 'NJ', filePrefix: 'trenton_nj' }
];

const trades = ['plumber', 'electrician', 'locksmith', 'hvac', 'roofer'];

async function importData() {
    console.log('Starting Trenton, NJ import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Trenton, NJ: ${totalImported} listings`);
}
