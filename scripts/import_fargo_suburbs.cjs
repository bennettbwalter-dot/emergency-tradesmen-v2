...
const cities = [
    { name: 'West Fargo', state: 'ND', filePrefix: 'westfargo_nd' },
    { name: 'Moorhead', state: 'MN', filePrefix: 'moorhead_mn' },
    { name: 'Horace', state: 'ND', filePrefix: 'horace_nd' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Fargo Suburbs (West Fargo, Moorhead, Horace) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Fargo Suburbs: ${totalImported} listings`);
}
