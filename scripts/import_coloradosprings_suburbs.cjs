...
const cities = [
    { name: 'Security-Widefield', state: 'CO', filePrefix: 'securitywidefield_co' },
    { name: 'Fountain', state: 'CO', filePrefix: 'fountain_co' },
    { name: 'Manitou Springs', state: 'CO', filePrefix: 'manitousprings_co' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Colorado Springs Suburbs (Security-Widefield, Fountain, Manitou Springs) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Colorado Springs Suburbs: ${totalImported} listings`);
}
