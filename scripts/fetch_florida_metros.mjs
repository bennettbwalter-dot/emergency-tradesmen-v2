...
const TARGET_CITIES = [
    { name: 'Miami', state: 'FL', center: { lat: 25.7617, lng: -80.1918 }, radius: 20, gridDensity: 5 },
    { name: 'Tampa', state: 'FL', center: { lat: 27.9506, lng: -82.4572 }, radius: 20, gridDensity: 5 },
    { name: 'Orlando', state: 'FL', center: { lat: 28.5383, lng: -81.3792 }, radius: 20, gridDensity: 5 },
    { name: 'Jacksonville', state: 'FL', center: { lat: 30.3322, lng: -81.6557 }, radius: 25, gridDensity: 4 }
];
...
async function collectData() {
    console.log("🐊 STARTING FLORIDA DATA COLLECTION\n");
        ...
        for (const trade of TRADES) {
            ...
            for (const cell of gridCells) {
                ...
                for (const place of places) {
                    ...
                    const uuid = toUUID(`google-us-fl-${details.place_id}`);
