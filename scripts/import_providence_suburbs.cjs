...
const cities = [
    { name: 'Cranston', state: 'RI', filePrefix: 'cranston_ri' },
    { name: 'Warwick', state: 'RI', filePrefix: 'warwick_ri' },
    { name: 'Pawtucket', state: 'RI', filePrefix: 'pawtucket_ri' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Providence Suburbs (Cranston, Warwick, Pawtucket) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Providence Suburbs: ${totalImported} listings`);
}
