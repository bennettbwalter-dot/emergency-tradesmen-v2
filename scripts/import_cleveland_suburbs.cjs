...
const cities = [
    { name: 'Parma', state: 'OH', filePrefix: 'parma_oh' },
    { name: 'Lakewood', state: 'OH', filePrefix: 'lakewood_oh' },
    { name: 'Euclid', state: 'OH', filePrefix: 'euclid_oh' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Cleveland Suburbs (Parma, Lakewood, Euclid) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Cleveland Suburbs: ${totalImported} listings`);
}
