...
const cities = [
    { name: 'Lodi', state: 'CA', filePrefix: 'lodi_ca' },
    { name: 'Manteca', state: 'CA', filePrefix: 'manteca_ca' },
    { name: 'Tracy', state: 'CA', filePrefix: 'tracy_ca' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Stockton Suburbs (Lodi, Manteca, Tracy) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Stockton Suburbs: ${totalImported} listings`);
}
