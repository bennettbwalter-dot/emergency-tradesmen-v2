...
const cities = [
    { name: 'Salem', state: 'VA', filePrefix: 'salem_va' },
    { name: 'Vinton', state: 'VA', filePrefix: 'vinton_va' },
    { name: 'Hollins', state: 'VA', filePrefix: 'hollins_va' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Roanoke Suburbs (Salem, Vinton, Hollins) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Roanoke Suburbs: ${totalImported} listings`);
}
