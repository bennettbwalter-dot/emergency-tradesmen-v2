...
const cities = [
    { name: 'Arlington', state: 'VA', filePrefix: 'arlington_va' },
    { name: 'Alexandria', state: 'VA', filePrefix: 'alexandria_va' },
    { name: 'Bethesda', state: 'MD', filePrefix: 'bethesda_md' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Washington DC Suburbs (Arlington, Alexandria, Bethesda) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Washington DC Suburbs: ${totalImported} listings`);
}
