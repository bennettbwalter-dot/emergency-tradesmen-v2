...
const batch8Cities = [
    { name: 'Mansfield', lat: 53.1432, lng: -1.1970 },
    { name: 'Barnsley', lat: 53.5526, lng: -1.4797 },
    { name: 'Guildford', lat: 51.2362, lng: -0.5704 },
    { name: 'Leatherhead', lat: 51.2942, lng: -0.3283 },
    { name: 'Sevenoaks', lat: 51.2720, lng: 0.1880 },
    { name: 'Tunbridge Wells', lat: 51.1325, lng: 0.2630 },
    { name: 'Reigate', lat: 51.2370, lng: -0.2070 },
    { name: 'Redhill', lat: 51.2390, lng: -0.1680 },
    { name: 'Epsom', lat: 51.3360, lng: -0.3270 },
...
importBatch().then(() => console.log('Batch 8 Builder Import Complete'));
