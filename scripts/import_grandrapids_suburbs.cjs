...
const cities = [
    { name: 'Wyoming', state: 'MI', filePrefix: 'wyoming_mi' },
    { name: 'Kentwood', state: 'MI', filePrefix: 'kentwood_mi' },
    { name: 'Walker', state: 'MI', filePrefix: 'walker_mi' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Grand Rapids Suburbs (Wyoming, Kentwood, Walker) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Grand Rapids Suburbs: ${totalImported} listings`);
}
