...
const batch7Cities = [
    ...
    { name: 'Lincoln', lat: 53.2295, lng: -0.5381 },
    { name: 'Chelmsford', lat: 51.7356, lng: 0.4685 },
    { name: 'Maidstone', lat: 51.2720, lng: 0.5230 },
    { name: 'Basingstoke', lat: 51.2625, lng: -1.0870 },
    { name: 'Worcester', lat: 52.1936, lng: -2.2215 },
    { name: 'Beeston', lat: 52.9270, lng: -1.2150 },
    { name: 'Eastleigh', lat: 50.9670, lng: -1.3530 },
    { name: 'Hastings', lat: 50.8550, lng: 0.5700 },
    { name: 'Eastbourne', lat: 50.7680, lng: 0.2850 }
];
...
importBatch().then(() => console.log('Batch 7 Builder Import Complete'));
