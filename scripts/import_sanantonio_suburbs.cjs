...
const cities = [
    { name: 'New Braunfels', state: 'TX', filePrefix: 'newbraunfels_tx' },
    { name: 'Schertz', state: 'TX', filePrefix: 'schertz_tx' },
    { name: 'Cibolo', state: 'TX', filePrefix: 'cibolo_tx' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting San Antonio Suburbs (New Braunfels, Schertz, Cibolo) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for San Antonio Suburbs: ${totalImported} listings`);
}
