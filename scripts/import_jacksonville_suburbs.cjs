...
const cities = [
    { name: 'Orange Park', state: 'FL', filePrefix: 'orangepark_fl' },
    { name: 'Fleming Island', state: 'FL', filePrefix: 'flemingisland_fl' },
    { name: 'Mandarin', state: 'FL', filePrefix: 'mandarin_fl' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Jacksonville Suburbs (Orange Park, Fleming Island, Mandarin) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Jacksonville Suburbs: ${totalImported} listings`);
}
