...
const cities = [
    { name: 'Penn Hills', state: 'PA', filePrefix: 'pennhills_pa' },
    { name: 'Mount Lebanon', state: 'PA', filePrefix: 'mountlebanon_pa' },
    { name: 'Bethel Park', state: 'PA', filePrefix: 'bethelpark_pa' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Pittsburgh Suburbs (Penn Hills, Mount Lebanon, Bethel Park) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Pittsburgh Suburbs: ${totalImported} listings`);
}
