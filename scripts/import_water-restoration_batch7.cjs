...
const waterRestorationCitiesBatch7 = [
    { name: "North Richland Hills", lat: 32.8343, lng: -97.2292 },
    ...
    { name: "Euless", lat: 32.8351, lng: -97.0817 },
    { name: "Port Arthur", lat: 29.8850, lng: -93.9287 },
    { name: "Grapevine", lat: 32.9343, lng: -97.0781 }
];

importTradeData(waterRestorationCitiesBatch7, 'water-restoration');
