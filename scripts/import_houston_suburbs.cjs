...
const cities = [
    { name: 'The Woodlands', state: 'TX', filePrefix: 'thewoodlands_tx' },
    { name: 'Katy', state: 'TX', filePrefix: 'katy_tx' },
    { name: 'Sugar Land', state: 'TX', filePrefix: 'sugarland_tx' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Houston Suburbs (The Woodlands, Katy, Sugar Land) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Houston Suburbs: ${totalImported} listings`);
}
