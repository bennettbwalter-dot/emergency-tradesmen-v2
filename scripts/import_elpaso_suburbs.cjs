...
const cities = [
    { name: 'Horizon City', state: 'TX', filePrefix: 'horizoncity_tx' },
    { name: 'Socorro', state: 'TX', filePrefix: 'socorro_tx' },
    { name: 'Canutillo', state: 'TX', filePrefix: 'canutillo_tx' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting El Paso Suburbs (Horizon City, Socorro, Canutillo) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for El Paso Suburbs: ${totalImported} listings`);
}
