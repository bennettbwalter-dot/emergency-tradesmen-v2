...
const cities = [
    { name: 'Overland Park', state: 'KS', filePrefix: 'overlandpark_ks' },
    { name: 'Kansas City', state: 'KS', filePrefix: 'kansascity_ks' },
    { name: 'Independence', state: 'MO', filePrefix: 'independence_mo' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Kansas City Suburbs (Overland Park, Kansas City KS, Independence) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Kansas City Suburbs: ${totalImported} listings`);
}
