...
const cities = [
    { name: 'Dearborn', state: 'MI', filePrefix: 'dearborn_mi' },
    { name: 'Livonia', state: 'MI', filePrefix: 'livonia_mi' },
    { name: 'Troy', state: 'MI', filePrefix: 'troy_mi' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Detroit Suburbs (Dearborn, Livonia, Troy) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Detroit Suburbs: ${totalImported} listings`);
}
