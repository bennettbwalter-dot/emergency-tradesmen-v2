...
const cities = [
    { name: 'Florissant', state: 'MO', filePrefix: 'florissant_mo' },
    { name: 'Chesterfield', state: 'MO', filePrefix: 'chesterfield_mo' },
    { name: 'OFallon', state: 'MO', filePrefix: 'ofallon_mo' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting St. Louis Suburbs (Florissant, Chesterfield, OFallon) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for St. Louis Suburbs: ${totalImported} listings`);
}
