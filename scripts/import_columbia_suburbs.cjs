...
const cities = [
    { name: 'Lexington', state: 'SC', filePrefix: 'lexington_sc' },
    { name: 'Irmo', state: 'SC', filePrefix: 'irmo_sc' },
    { name: 'Cayce', state: 'SC', filePrefix: 'cayce_sc' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Columbia (SC) Suburbs (Lexington, Irmo, Cayce) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Columbia (SC) Suburbs: ${totalImported} listings`);
}
