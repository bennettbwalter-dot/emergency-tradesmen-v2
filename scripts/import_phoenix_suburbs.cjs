...
const cities = [
    { name: 'Scottsdale', state: 'AZ', filePrefix: 'scottsdale_az' },
    { name: 'Mesa', state: 'AZ', filePrefix: 'mesa_az' },
    { name: 'Chandler', state: 'AZ', filePrefix: 'chandler_az' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Phoenix Suburbs (Scottsdale, Mesa, Chandler) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Phoenix Suburbs: ${totalImported} listings`);
}
