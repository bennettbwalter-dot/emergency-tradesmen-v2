...
const cities = [
    { name: 'Indianapolis', state: 'IN', prefix: 'indianapolis_in' }
];
...
async function importIndianapolis() {
    console.log('Starting Phase 25 (Indiana - Indianapolis) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Phase 25 (Indiana - Indy): ${totalImported} listings`);
}
