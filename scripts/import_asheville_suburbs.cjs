...
const cities = [
    { name: 'Black Mountain', state: 'NC', filePrefix: 'blackmountain_nc' },
    { name: 'Weaverville', state: 'NC', filePrefix: 'weaverville_nc' },
    { name: 'Woodfin', state: 'NC', filePrefix: 'woodfin_nc' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Asheville Suburbs (Black Mountain, Weaverville, Woodfin) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Asheville Suburbs: ${totalImported} listings`);
}
