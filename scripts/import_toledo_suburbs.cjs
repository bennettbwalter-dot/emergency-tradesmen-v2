...
const cities = [
    { name: 'Sylvania', state: 'OH', filePrefix: 'sylvania_oh' },
    { name: 'Maumee', state: 'OH', filePrefix: 'maumee_oh' },
    { name: 'Perrysburg', state: 'OH', filePrefix: 'perrysburg_oh' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Toledo Suburbs (Sylvania, Maumee, Perrysburg) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Toledo Suburbs: ${totalImported} listings`);
}
