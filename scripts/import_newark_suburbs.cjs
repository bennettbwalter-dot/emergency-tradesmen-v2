...
const cities = [
    { name: 'East Orange', state: 'NJ', filePrefix: 'eastorange_nj' },
    { name: 'Irvington', state: 'NJ', filePrefix: 'irvington_nj' },
    { name: 'Bloomfield', state: 'NJ', filePrefix: 'bloomfield_nj' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Newark Suburbs (East Orange, Irvington, Bloomfield) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Newark Suburbs: ${totalImported} listings`);
}
