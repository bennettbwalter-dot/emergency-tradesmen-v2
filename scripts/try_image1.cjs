...
const getReq = https.request({
    ...
    res.on('end', () => {
        ...
        // Try image 1 with cache bust
        const timestamp = Date.now();
        content = content.replace('/images/blog/generated/portable-power-stations.png?v=', `/images/blog/generated/portable-power-stations-1.png?v=${timestamp}`);
        console.log('Changed to image 1 with cache bust');
