...
const files = [
    'grapevine_glass_real.json',
    'newyorkcity_glass_real.json',
    'chicago_glass_real.json'
];

async function importGlassRepair() {
    console.log('🚀 Starting Phase 8 Batch 20: Emergency Glass Repair Import (Final Markets)...');
    ...
    for (const file of files) {
        ...
        const cityMapping = {
            'grapevine_glass_real.json': 'Grapevine',
            'newyorkcity_glass_real.json': 'New York City',
            'chicago_glass_real.json': 'Chicago'
        };
    ...
    console.log('✅ Phase 8 Batch 20 Import Complete!');
}
