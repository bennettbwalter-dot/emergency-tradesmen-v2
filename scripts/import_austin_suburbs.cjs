...
const cities = [
    { name: 'Round Rock', state: 'TX', filePrefix: 'roundrock_tx' },
    { name: 'Cedar Park', state: 'TX', filePrefix: 'cedarpark_tx' },
    { name: 'Georgetown', state: 'TX', filePrefix: 'georgetown_tx' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Austin Suburbs (Round Rock, Cedar Park, Georgetown) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Austin Suburbs: ${totalImported} listings`);
}
