...
const cities = [
    { name: 'Hoover', state: 'AL', filePrefix: 'hoover_al' },
    { name: 'Vestavia Hills', state: 'AL', filePrefix: 'vestaviahills_al' },
    { name: 'Alabaster', state: 'AL', filePrefix: 'alabaster_al' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Birmingham Suburbs (Hoover, Vestavia Hills, Alabaster) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Birmingham Suburbs: ${totalImported} listings`);
}
