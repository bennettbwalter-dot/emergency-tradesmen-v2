...
const cities = [
    { name: 'Madison', state: 'AL', filePrefix: 'madison_al' },
    { name: 'Athens', state: 'AL', filePrefix: 'athens_al' },
    { name: 'Decatur', state: 'AL', filePrefix: 'decatur_al' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Huntsville (AL) Suburbs (Madison, Athens, Decatur) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Huntsville (AL) Suburbs: ${totalImported} listings`);
}
