...
const CITY_COORDINATES = {
    ...
    "Lewisville": { lat: 33.0454, lng: -96.9906 },
...
const files = [
    'carrollton_glass_real.json',
    'richardson_glass_real.json',
    'lewisville_glass_real.json',
    'roundrock_glass_real.json',
    'collegestation_glass_real.json',
    'tyler_glass_real.json'
];

async function importGlassRepair() {
    console.log('🚀 Starting Phase 8 Batch 15: Emergency Glass Repair Import (Texas Expansion)...');
    ...
    for (const file of files) {
        ...
        const cityMapping = {
            'carrollton_glass_real.json': 'Carrollton',
            'richardson_glass_real.json': 'Richardson',
            'lewisville_glass_real.json': 'Lewisville',
            'roundrock_glass_real.json': 'Round Rock',
            'collegestation_glass_real.json': 'College Station',
            'tyler_glass_real.json': 'Tyler'
        };
    ...
    console.log('✅ Phase 8 Batch 15 Import Complete!');
}
