...
const batch10Cities = [
    ...
    { name: 'Bexhill', lat: 50.8427, lng: 0.4735 },
    { name: 'Seaford', lat: 50.7719, lng: 0.1026 },
    { name: 'Newhaven', lat: 50.7925, lng: 0.0543 },
    { name: 'Lewes', lat: 50.8741, lng: 0.0121 },
    { name: 'Uckfield', lat: 50.9698, lng: 0.0913 },
    { name: 'Crowborough', lat: 51.0601, lng: 0.1601 },
    { name: 'Burgess Hill', lat: 50.9526, lng: -0.1265 },
    { name: 'Haywards Heath', lat: 51.0020, lng: -0.1065 },
    { name: 'Tonbridge', lat: 51.1963, lng: 0.2748 }
];
...
importBatch().then(() => console.log('Batch 10 UK Plumber Import Complete'));
