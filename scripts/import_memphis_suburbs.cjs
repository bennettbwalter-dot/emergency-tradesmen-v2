...
const cities = [
    { name: 'Bartlett', state: 'TN', filePrefix: 'bartlett_tn' },
    { name: 'Germantown', state: 'TN', filePrefix: 'germantown_tn' },
    { name: 'Collierville', state: 'TN', filePrefix: 'collierville_tn' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Memphis Suburbs (Bartlett, Germantown, Collierville) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Memphis Suburbs: ${totalImported} listings`);
}
