...
print(f"--- Direct 'photos' Column Check against {p2_url} ---")

# Try to select the 'photos' column
url = f"{p2_url}/rest/v1/businesses?select=id,name,photos&limit=1"
headers = {
    "apikey": p2_key,
...
try:
    ...
    if response.status_code == 200:
        print("✅ SUCCESS: The column 'photos' exists!")
    else:
