...
const cities = [
    { name: 'Edmond', state: 'OK', filePrefix: 'edmond_ok' },
    { name: 'Norman', state: 'OK', filePrefix: 'norman_ok' },
    { name: 'Moore', state: 'OK', filePrefix: 'moore_ok' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Oklahoma City Suburbs (Edmond, Norman, Moore) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Oklahoma City Suburbs: ${totalImported} listings`);
}
