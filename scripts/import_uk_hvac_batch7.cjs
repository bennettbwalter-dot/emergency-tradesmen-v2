...
const ukHVACCitiesBatch7 = [
    { name: "Scunthorpe", lat: 53.5857, lng: -0.6558 },
    { name: "Southport", lat: 53.6477, lng: -3.0065 },
    { name: "Barnsley", lat: 53.5526, lng: -1.4797 },
    { name: "Bracknell", lat: 51.4163, lng: -0.7511 },
    { name: "Chesterfield", lat: 53.2350, lng: -1.4239 },
    { name: "Castleford", lat: 53.7258, lng: -1.3533 },
    { name: "Loughborough", lat: 52.7705, lng: -1.2046 },
    { name: "Halifax", lat: 53.7250, lng: -1.8630 },
    { name: "Widnes", lat: 53.3630, lng: -2.7282 },
    { name: "Bury", lat: 53.5933, lng: -2.2966 }
];

importUKTradeData(ukHVACCitiesBatch7, 'hvac');
