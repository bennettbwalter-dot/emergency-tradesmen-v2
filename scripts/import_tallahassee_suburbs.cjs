...
const cities = [
    { name: 'Quincy', state: 'FL', filePrefix: 'quincy_fl' },
    { name: 'Crawfordville', state: 'FL', filePrefix: 'crawfordville_fl' },
    { name: 'Midway', state: 'FL', filePrefix: 'midway_fl' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Tallahassee Suburbs (Quincy, Crawfordville, Midway) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Tallahassee Suburbs: ${totalImported} listings`);
}
