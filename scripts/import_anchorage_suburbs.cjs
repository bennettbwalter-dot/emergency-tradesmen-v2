...
const cities = [
    { name: 'Eagle River', state: 'AK', filePrefix: 'eagleriver_ak' },
    { name: 'Wasilla', state: 'AK', filePrefix: 'wasilla_ak' },
    { name: 'Palmer', state: 'AK', filePrefix: 'palmer_ak' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Anchorage Suburbs (Eagle River, Wasilla, Palmer) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Anchorage Suburbs: ${totalImported} listings`);
}
