...
const cities = [
    { name: 'Ceres', state: 'CA', filePrefix: 'ceres_ca' },
    { name: 'Turlock', state: 'CA', filePrefix: 'turlock_ca' },
    { name: 'Riverbank', state: 'CA', filePrefix: 'riverbank_ca' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Modesto Suburbs (Ceres, Turlock, Riverbank) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Modesto Suburbs: ${totalImported} listings`);
}
