...
const cities = [
    { name: 'Concord', state: 'NC', filePrefix: 'concord_nc' },
    { name: 'Gastonia', state: 'NC', filePrefix: 'gastonia_nc' },
    { name: 'Rock Hill', state: 'SC', filePrefix: 'rockhill_sc' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Charlotte Suburbs (Concord, Gastonia, Rock Hill) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Charlotte Suburbs: ${totalImported} listings`);
}
