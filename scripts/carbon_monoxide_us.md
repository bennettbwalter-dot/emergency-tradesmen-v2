**Forced Air & Cracked Heat Exchangers: Most US homes use forced-air furnaces. If the "heat exchanger" (the metal chamber where fire burns) cracks from age, the blower fan can push CO directly into your ducts, pumping poison into every bedroom in the house simultaneously. The [CDC](https://www.cdc.gov/co/faqs.htm) warns that this can happen without any visible smoke. For more on seasonal HVAC risks, see our [Spring Thaw Prevention](/blog/spring-thaw-pipe-burst-prevention) guide.**
...
*   *DIY Warning:* Touching these without discharging them can cause severe shock or electrocution. Leave the panel closed! For details on electrical safety, see our [Electrical Emergencies Guide](/blog/electrical-emergencies-every-homeowner-should-know).

**Back-Drafting:** In modern, airtight homes, running a strong kitchen exhaust fan or fireplace can suck air down your furnace flue instead of letting it go up. This pulls CO back into your living room—a phenomenon highlighted by [EPA Indoor Air Quality](https://www.epa.gov/indoor-air-quality-iaq/carbon-monoxides-impact-indoor-air-quality) guidelines.
...
*   **Understanding the "Red Tag":** If a technician finds a danger, they will place a Red Tag on your unit. Refer to the [NFPA 54 (National Fuel Gas Code)](https://www.nfpa.org/codes-and-standards/all-codes-and-standards/list-of-codes-and-standards/detail?code=54) for safety standards.
...
*   **Do Not DIY the Repair:** Removing a Red Tag yourself is often illegal and voids your home insurance. You need a signed "affidavit of repair" from a licensed pro to restore service. See our [Home Shut-off Protocol](/blog/home-emergency-shut-off-protocol-us) for emergency steps.
...
**Alarm Placement:** The CPSC recommends CO alarms on every level of the home and outside each sleeping area. If you have a basement with a bedroom, put one there too. Check the [NFPA 720](https://www.nfpa.org/) for specific placement rules.
...
A Red Tag on your furnace is scary, but ignoring it is worse. Don't gamble with your family's safety. For a broader overview of home safety, read [What to do in a Home Emergency](/blog/what-to-do-in-home-emergency-before-help-arrives-us).
