...
const cities = [
    { name: 'Liverpool', state: 'NY', filePrefix: 'liverpool_ny' },
    { name: 'Cicero', state: 'NY', filePrefix: 'cicero_ny' },
    { name: 'Manlius', state: 'NY', filePrefix: 'manlius_ny' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Syracuse Suburbs (Liverpool, Cicero, Manlius) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Syracuse Suburbs: ${totalImported} listings`);
}
