...
async function updatePosts() {
    const gbContent = fs.readFileSync('scripts/expanded_car_guide_gb.md', 'utf8');
    const usContent = fs.readFileSync('scripts/expanded_car_guide_us.md', 'utf8');
    ...
    const { error: gbError } = await supabase
        ...
        .eq('slug', 'car-wont-start-flat-battery-alternator-gb');
