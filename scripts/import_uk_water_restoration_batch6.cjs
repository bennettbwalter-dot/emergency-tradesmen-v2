...
const ukWaterRestorationCitiesBatch6 = [
    { name: "Worthing", lat: 50.8147, lng: -0.3714 },
    { name: "Telford", lat: 52.6776, lng: -2.4430 },
    { name: "Crawley", lat: 51.1132, lng: -0.1831 },
    { name: "Bedford", lat: 52.1360, lng: -0.4666 },
    { name: "Gillingham", lat: 51.3687, lng: 0.5492 },
    { name: "Birkenhead", lat: 53.3934, lng: -3.0147 },
    { name: "Tamworth", lat: 52.6339, lng: -1.6934 },
    { name: "Eastbourne", lat: 50.7680, lng: 0.2854 },
    { name: "Grays", lat: 51.4749, lng: 0.3242 },
    { name: "St Albans", lat: 51.7527, lng: -0.3394 }
];

importUKTradeData(ukWaterRestorationCitiesBatch6, 'water-restoration');
