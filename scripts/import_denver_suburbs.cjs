...
const cities = [
    { name: 'Aurora', state: 'CO', filePrefix: 'aurora_co' },
    { name: 'Lakewood', state: 'CO', filePrefix: 'lakewood_co' },
    { name: 'Littleton', state: 'CO', filePrefix: 'littleton_co' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Denver Suburbs (Aurora, Lakewood, Littleton) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Denver Suburbs: ${totalImported} listings`);
}
