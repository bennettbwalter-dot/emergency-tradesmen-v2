...
const cities = [
    { name: 'Mount Pleasant', state: 'SC', filePrefix: 'mountpleasant_sc' },
    { name: 'North Charleston', state: 'SC', filePrefix: 'northcharleston_sc' },
    { name: 'Hanahan', state: 'SC', filePrefix: 'hanahan_sc' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Charleston Suburbs (Mount Pleasant, North Charleston, Hanahan) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Charleston Suburbs: ${totalImported} listings`);
}
