...
const files = [
    'lasvegas_glass_real.json',
    'portland_glass_real.json',
    'louisville_glass_real.json',
    'milwaukee_glass_real.json',
    'baltimore_glass_real.json',
    'albuquerque_glass_real.json'
];

async function importGlassRepair() {
    console.log('🚀 Starting Phase 8 Batch 5: Emergency Glass Repair Import...');
    ...
    for (const file of files) {
        ...
        const cityMapping = {
            'lasvegas_glass_real.json': 'Las Vegas',
            'portland_glass_real.json': 'Portland',
            'louisville_glass_real.json': 'Louisville',
            'milwaukee_glass_real.json': 'Milwaukee',
            'baltimore_glass_real.json': 'Baltimore',
            'albuquerque_glass_real.json': 'Albuquerque'
        };
    ...
    console.log('✅ Phase 8 Batch 5 Import Complete!');
}
