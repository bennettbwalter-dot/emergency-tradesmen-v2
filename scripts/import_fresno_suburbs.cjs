...
const cities = [
    { name: 'Clovis', state: 'CA', filePrefix: 'clovis_ca' },
    { name: 'Sanger', state: 'CA', filePrefix: 'sanger_ca' },
    { name: 'Reedley', state: 'CA', filePrefix: 'reedley_ca' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Fresno Suburbs (Clovis, Sanger, Reedley) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Fresno Suburbs: ${totalImported} listings`);
}
