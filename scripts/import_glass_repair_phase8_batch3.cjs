...
const files = [
    'sanjose_glass_real.json',
    'austin_glass_real.json',
    'jacksonville_glass_real.json',
    'sanfrancisco_glass_real.json',
    'memphis_glass_real.json',
    'seattle_glass_real.json'
];

async function importGlassRepair() {
    console.log('🚀 Starting Phase 8 Batch 3: Emergency Glass Repair Import...');
    ...
    for (const file of files) {
        ...
        const cityMapping = {
            'sanjose_glass_real.json': 'San Jose',
            'austin_glass_real.json': 'Austin',
            'jacksonville_glass_real.json': 'Jacksonville',
            'sanfrancisco_glass_real.json': 'San Francisco',
            'memphis_glass_real.json': 'Memphis',
            'seattle_glass_real.json': 'Seattle'
        };
    ...
    console.log('✅ Phase 8 Batch 3 Import Complete!');
}
