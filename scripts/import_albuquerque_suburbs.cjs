...
const cities = [
    { name: 'Rio Rancho', state: 'NM', filePrefix: 'riorancho_nm' },
    { name: 'Los Lunas', state: 'NM', filePrefix: 'loslunas_nm' },
    { name: 'Bernalillo', state: 'NM', filePrefix: 'bernalillo_nm' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Albuquerque Suburbs (Rio Rancho, Los Lunas, Bernalillo) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Albuquerque Suburbs: ${totalImported} listings`);
}
