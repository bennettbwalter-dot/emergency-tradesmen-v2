...
async function fetchLondonBreakdown() {
    console.log("Fetching 'Emergency Breakdown Recovery London' from Google Places...");

    // We want specifically breakdown recovery
    const query = "Emergency Breakdown Recovery London";
    ...
    const businesses = results.map(place => {
        ...
        return {
            ...
            name: place.name,
            trade: 'breakdown',
            city: 'london', // lowercase to match my finding in deep search
