...
const batch8Cities = [
    { name: 'Mansfield', lat: 53.1472, lng: -1.1988 },
    { name: 'Barnsley', lat: 53.5526, lng: -1.4797 },
    { name: 'Guildford', lat: 51.2362, lng: -0.5704 },
    { name: 'Leatherhead', lat: 51.2965, lng: -0.3276 },
    { name: 'Sevenoaks', lat: 51.2709, lng: 0.1916 },
    { name: 'Tunbridge Wells', lat: 51.1328, lng: 0.2638 },
    { name: 'Reigate', lat: 51.2372, lng: -0.2057 },
    { name: 'Redhill', lat: 51.2396, lng: -0.1685 },
    { name: 'Epsom', lat: 51.3323, lng: -0.2662 },
...
importBatch().then(() => console.log('Batch 8 UK Plumber Import Complete'));
