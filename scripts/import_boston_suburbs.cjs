...
const cities = [
    { name: 'Cambridge', state: 'MA', filePrefix: 'cambridge_ma' },
    { name: 'Somerville', state: 'MA', filePrefix: 'somerville_ma' },
    { name: 'Quincy', state: 'MA', filePrefix: 'quincy_ma' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Boston Suburbs (Cambridge, Somerville, Quincy) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Boston Suburbs: ${totalImported} listings`);
}
