...
const cities = [
    { name: 'Spartanburg', state: 'SC', filePrefix: 'spartanburg_sc' },
    { name: 'Anderson', state: 'SC', filePrefix: 'anderson_sc' },
    { name: 'Greer', state: 'SC', filePrefix: 'greer_sc' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Greenville Suburbs (Spartanburg, Anderson, Greer) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Greenville Suburbs: ${totalImported} listings`);
}
