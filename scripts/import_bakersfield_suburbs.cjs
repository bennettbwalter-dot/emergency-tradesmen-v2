...
const cities = [
    { name: 'Tehachapi', state: 'CA', filePrefix: 'tehachapi_ca' },
    { name: 'Delano', state: 'CA', filePrefix: 'delano_ca' },
    { name: 'Wasco', state: 'CA', filePrefix: 'wasco_ca' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Bakersfield Suburbs (Tehachapi, Delano, Wasco) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Bakersfield Suburbs: ${totalImported} listings`);
}
