...
const batch1Data = [
    ...
    { name: "Ambition Electric", city: "Lincoln", state: "NE", phone: "402-555-0104", trade: "electrician", rating: 4.9, reviewCount: 34, featuredReview: "Top notch emergency service.", address: "Lincoln, NE" },
];
            ...
            .insert([
                {
                    ...
                    is_verified: true,
                    tier: 'free',
                    // Random coordinates around city center
