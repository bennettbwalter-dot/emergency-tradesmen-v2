...
const cities = [
    { name: 'Pooler', state: 'GA', filePrefix: 'pooler_ga' },
    { name: 'Wilmington Island', state: 'GA', filePrefix: 'wilmingtonisland_ga' },
    { name: 'Garden City', state: 'GA', filePrefix: 'gardencity_ga' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Savannah Suburbs (Pooler, Wilmington Island, Garden City) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Savannah Suburbs: ${totalImported} listings`);
}
