...
const cities = [
    { name: 'Salt Lake City', state: 'UT', filePrefix: 'saltlakecity_ut' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Salt Lake City, UT import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Salt Lake City, UT: ${totalImported} listings`);
}
