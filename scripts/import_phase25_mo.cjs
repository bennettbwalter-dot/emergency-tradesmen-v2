...
const cities = [
    { name: 'Kansas City', state: 'MO', prefix: 'kansas_city_mo' }
];
...
async function importMissouri() {
    console.log('Starting Phase 25 (Missouri - Kansas City) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Phase 25 (Missouri - KC): ${totalImported} listings`);
}
