...
const cities = [
    { name: 'Marietta', state: 'GA', filePrefix: 'marietta_ga' },
    { name: 'Alpharetta', state: 'GA', filePrefix: 'alpharetta_ga' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Atlanta Suburbs (Marietta, Alpharetta) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Atlanta Suburbs: ${totalImported} listings`);
}
