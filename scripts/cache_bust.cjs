...
const getReq = https.request({
    ...
    res.on('end', () => {
        ...
        const newSrc = `/images/blog/generated/portable-power-stations.png?v=${timestamp}`;
        content = content.replace('https://via.placeholder.com/280x280/ff9900/111111?text=POWER+STATION', newSrc);
        console.log('Added cache bust:', timestamp);
