...
**Hidden Flue Failures:** In many modern flats or refurbished homes, boiler flues (exhaust pipes) run through ceiling voids. If these disconnect or degrade, they can leak gas into the space above you without you seeing a thing. The [HSE](https://www.hse.gov.uk/gas/domestic/) warns that inspection hatches are often required to spot these hidden dangers. If you suspect a problem with your heating system, consult our [Boiler Pressure Guide](/blog/boiler-pressure-dropping-filling-loop-gb) for common warning signs.

![Hidden Flue Failures](/images/blog/co-safety/hidden-flues.jpg "Hidden Flue Failures")

**The "Tight Home" Problem:** We all want energy-efficient, draught-free homes. But if you block up old air bricks or install super-sealed double glazing without adding trickle vents, your older open-flued appliances might starve for oxygen, creating CO instead of safe exhaust gases. This is a common issue with older [Gas Safety](/blog/smell-gas-what-to-do-safety-protocol-gb) protocols that focused on ventilation.
...
*   **Stop the Source:** Turn off all gas appliances. If the meter is accessible and safe to reach (not in a cellar full of fumes), turn the Emergency Control Valve (ECV) to "OFF" (the lever should cross the pipe). See our [Home Emergency Shut-off Guide](/blog/home-emergency-stopcock-fusebox-gb) for locating valves.
...
*   **Get Checked Out:** Go to A&E or your GP and explicitly mention "suspected Carbon Monoxide poisoning" so they can test your blood for carboxyhaemoglobin levels. Refer to the [Public Health England](https://www.gov.uk/government/organisations/public-health-england) guidance for long-term health monitoring.
...
**The 2022 Alarm Update:** As of October 2022, [UK Building Regulations](https://www.gov.uk/government/publications/carbon-monoxide-alarms-in-rented-and-owned-homes-guidance) require a CO alarm in **any room** used as living accommodation that has a fixed combustion appliance (like a boiler or fire). This includes rental properties!

### Don't Wait For A Headache

Don't wait for a headache to tell you your boiler is broken. Peace of mind is just one click away. If you're experiencing multiple home issues, read our [What to do in a Home Emergency](/blog/what-to-do-in-home-emergency-before-help-arrives-gb) guide.
