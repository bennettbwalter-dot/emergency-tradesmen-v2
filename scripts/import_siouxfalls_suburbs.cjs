...
const cities = [
    { name: 'Brandon', state: 'SD', filePrefix: 'brandon_sd' },
    { name: 'Harrisburg', state: 'SD', filePrefix: 'harrisburg_sd' },
    { name: 'Tea', state: 'SD', filePrefix: 'tea_sd' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Sioux Falls Suburbs (Brandon, Harrisburg, Tea) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Sioux Falls Suburbs: ${totalImported} listings`);
}
