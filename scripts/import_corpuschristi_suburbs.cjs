...
const cities = [
    { name: 'Portland', state: 'TX', filePrefix: 'portland_tx' },
    { name: 'Robstown', state: 'TX', filePrefix: 'robstown_tx' },
    { name: 'Flour Bluff', state: 'TX', filePrefix: 'flourbluff_tx' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Corpus Christi Suburbs (Portland, Robstown, Flour Bluff) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Corpus Christi Suburbs: ${totalImported} listings`);
}
