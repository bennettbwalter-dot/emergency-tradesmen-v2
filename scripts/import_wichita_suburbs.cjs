...
const cities = [
    { name: 'Derby', state: 'KS', filePrefix: 'derby_ks' },
    { name: 'Andover', state: 'KS', filePrefix: 'andover_ks' },
    { name: 'Haysville', state: 'KS', filePrefix: 'haysville_ks' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Wichita Suburbs (Derby, Andover, Haysville) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Wichita Suburbs: ${totalImported} listings`);
}
