...
const cities = [
    { name: 'Greece', state: 'NY', filePrefix: 'greece_ny' },
    { name: 'Irondequoit', state: 'NY', filePrefix: 'irondequoit_ny' },
    { name: 'Brighton', state: 'NY', filePrefix: 'brighton_ny' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Rochester Suburbs (Greece, Irondequoit, Brighton) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Rochester Suburbs: ${totalImported} listings`);
}
