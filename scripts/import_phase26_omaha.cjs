...
const cities = [
    { name: 'Omaha', state: 'NE', prefix: 'omaha_ne' }
];
...
async function importOmaha() {
    console.log('Starting Phase 26 (Omaha) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Phase 26 (Omaha): ${totalImported} listings`);
}
