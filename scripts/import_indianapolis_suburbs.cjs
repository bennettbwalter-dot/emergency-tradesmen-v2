...
const cities = [
    { name: 'Carmel', state: 'IN', filePrefix: 'carmel_in' },
    { name: 'Fishers', state: 'IN', filePrefix: 'fishers_in' },
    { name: 'Noblesville', state: 'IN', filePrefix: 'noblesville_in' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Indianapolis Suburbs (Carmel, Fishers, Noblesville) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Indianapolis Suburbs: ${totalImported} listings`);
}
