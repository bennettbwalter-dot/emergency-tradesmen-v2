...
const cities = [
    { name: 'Fayetteville', state: 'AR', filePrefix: 'fayetteville_ar' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Fayetteville, AR import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Fayetteville, AR: ${totalImported} listings`);
}
