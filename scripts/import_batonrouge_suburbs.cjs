...
const cities = [
    { name: 'Prairieville', state: 'LA', filePrefix: 'prairieville_la' },
    { name: 'Central', state: 'LA', filePrefix: 'central_la' },
    { name: 'Zachary', state: 'LA', filePrefix: 'zachary_la' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Baton Rouge Suburbs (Prairieville, Central, Zachary) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Baton Rouge Suburbs: ${totalImported} listings`);
}
