...
const getReq = https.request({
    ...
    res.on('end', () => {
        ...
        // Replace the low quality image with the main one
        content = content.replace('/images/blog/generated/portable-power-stations-2.jpg', '/images/blog/generated/portable-power-stations.png');
