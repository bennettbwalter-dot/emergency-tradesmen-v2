...
const originalSrc = 'https://images.unsplash.com/photo-1622470953794-aa9c70b0fb9a?w=400';
...
const getReq = https.request({
    ...
    res.on('end', () => {
        ...
        content = content.replace('/images/blog/generated/portable-power-stations-2.jpg', originalSrc);
