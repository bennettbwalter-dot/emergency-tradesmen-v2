...
const files = [
    'denton_gap_real.json',
    'waco_gap_real.json',
    'carrollton_gap_real.json',
    'lewisville_gap_real.json',
    'roundrock_gap_real.json',
    'collegestation_gap_real.json',
    'tyler_gap_real.json',
    'pearland_gap_real.json',
    'sugarland_gap_real.json',
    'allen_gap_real.json'
];
