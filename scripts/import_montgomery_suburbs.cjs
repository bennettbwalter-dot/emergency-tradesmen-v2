...
const cities = [
    { name: 'Prattville', state: 'AL', filePrefix: 'prattville_al' },
    { name: 'Millbrook', state: 'AL', filePrefix: 'millbrook_al' },
    { name: 'Wetumpka', state: 'AL', filePrefix: 'wetumpka_al' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Montgomery Suburbs (Prattville, Millbrook, Wetumpka) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Montgomery Suburbs: ${totalImported} listings`);
}
