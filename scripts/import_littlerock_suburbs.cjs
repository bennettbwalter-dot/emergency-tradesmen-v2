...
const cities = [
    { name: 'North Little Rock', state: 'AR', filePrefix: 'northlittlerock_ar' },
...
async function importData() {
    console.log('Starting Little Rock Suburbs (North Little Rock, Conway, Benton) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Little Rock Suburbs: ${totalImported} listings`);
}
