...
const cities = [
    { name: 'Sparks', state: 'NV', filePrefix: 'sparks_nv' },
    { name: 'Sun Valley', state: 'NV', filePrefix: 'sunvalley_nv' },
    { name: 'Mogul', state: 'NV', filePrefix: 'mogul_nv' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Reno Suburbs (Sparks, Sun Valley, Mogul) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Reno Suburbs: ${totalImported} listings`);
}
