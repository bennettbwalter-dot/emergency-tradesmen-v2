...
const cities = [
    { name: 'St. Louis', state: 'MO', prefix: 'st_louis_mo' }
];
...
async function importStLouis() {
    console.log('Starting Phase 25 (Missouri - St. Louis) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Phase 25 (Missouri - STL): ${totalImported} listings`);
}
