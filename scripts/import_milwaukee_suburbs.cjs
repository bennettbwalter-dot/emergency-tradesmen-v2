...
const cities = [
    { name: 'Wauwatosa', state: 'WI', filePrefix: 'wauwatosa_wi' },
    { name: 'West Allis', state: 'WI', filePrefix: 'westallis_wi' },
    { name: 'Brookfield', state: 'WI', filePrefix: 'brookfield_wi' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Milwaukee Suburbs (Wauwatosa, West Allis, Brookfield) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Milwaukee Suburbs: ${totalImported} listings`);
}
