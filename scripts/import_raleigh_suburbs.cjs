...
const cities = [
    { name: 'Cary', state: 'NC', filePrefix: 'cary_nc' },
    { name: 'Durham', state: 'NC', filePrefix: 'durham_nc' },
    { name: 'Apex', state: 'NC', filePrefix: 'apex_nc' }
];

const trades = ['plumber', 'electrician'];

async function importData() {
    console.log('Starting Raleigh Suburbs (Cary, Durham, Apex) import...');
    let totalImported = 0;
    ...
    console.log(`\nTotal imported for Raleigh Suburbs: ${totalImported} listings`);
}
