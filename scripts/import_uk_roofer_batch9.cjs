...
const batch9Cities = [
    { name: 'Gravesend', lat: 51.4415, lng: 0.3685 },
    { name: 'Rochester', lat: 51.3875, lng: 0.505 },
    { name: 'Chatham', lat: 51.3789, lng: 0.5273 },
    { name: 'Sittingbourne', lat: 51.34, lng: 0.74 },
    { name: 'Faversham', lat: 51.314, lng: 0.89 },
    { name: 'Canterbury', lat: 51.2802, lng: 1.0789 },
    { name: 'Margate', lat: 51.381, lng: 1.386 },
    { name: 'Ramsgate', lat: 51.336, lng: 1.416 },
    { name: 'Dover', lat: 51.1279, lng: 1.3132 },
    { name: 'Folkestone', lat: 51.081, lng: 1.178 }
];
...
importBatch().then(() => console.log('Batch 9 UK Roofer Import Complete'));
