...
// Target Pacific Northwest Cities
const TARGET_CITIES = [
    { name: 'Seattle', state: 'WA', center: { lat: 47.6062, lng: -122.3321 }, radius: 20, gridDensity: 5 },
    { name: 'Portland', state: 'OR', center: { lat: 45.5152, lng: -122.6784 }, radius: 18, gridDensity: 5 },
    { name: 'Tacoma', state: 'WA', center: { lat: 47.2529, lng: -122.4443 }, radius: 12, gridDensity: 4 },
    { name: 'Spokane', state: 'WA', center: { lat: 47.6588, lng: -117.4260 }, radius: 15, gridDensity: 4 }
];
...
const TRADES = [
    ...
    { query: 'roof repair', slug: 'roofer' }  // Rain damage focus
];
...
async function collectData() {
    console.log("🌲 STARTING PACIFIC NORTHWEST DATA COLLECTION\n");
        ...
        for (const trade of TRADES) {
            ...
            for (const cell of gridCells) {
                ...
                for (const place of places) {
                    ...
                    const uuid = toUUID(`google-us-pnw-${details.place_id}`);
    ...
    console.log("\n🎉 ALL PACIFIC NORTHWEST CITIES COMPLETE");
}
