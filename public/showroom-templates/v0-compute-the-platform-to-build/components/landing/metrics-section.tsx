...
const metrics = [
  { 
    ...
    sublabel: "across all service areas",
  },
  { 
    value: 99, 
    suffix: ".9%", 
  ...
  return (
    <section ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="lg:col-span-8 lg:col-start-1">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-sm font-mono text-muted-foreground">
                {time ? `${time.toLocaleTimeString("en-GB")} Local` : ""}
              </span>
            </div>
        ...
        {/* Smart lock image */}
        <div className={`w-full mb-8 transition-all duration-1000 delay-200 relative overflow-hidden rounded-lg ${
          isVisible ? "opacity-100" : "opacity-0"
        }`}>
          <img
            src="/images/smart-lock.jpg"
            alt=""
            aria-hidden="true"
            className="w-full h-[300px] object-cover"
          />
          {/* Red accent overlay */}
          <div className="absolute inset-0 bg-gradient-to-r from-red-900/40 via-red-700/20 to-transparent mix-blend-multiply" />
          <div className="absolute inset-0 bg-gradient-to-t from-red-600/30 via-transparent to-red-500/20" />
        </div>
        ...
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
          ...
          <span>Yale</span>
          <span>Medeco</span>
          <span className="text-foreground">+50 more brands</span>
        </div>
      </div>
    </section>
  );
