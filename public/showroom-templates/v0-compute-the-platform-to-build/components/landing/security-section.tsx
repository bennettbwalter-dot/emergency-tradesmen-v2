...
const securityFeatures = [
  {
    ...
    description: "Fully licensed, bonded, and insured technicians.",
  },
  {
    icon: Lock,
    title: "Background Checked",
    description: "Every technician passes rigorous background checks.",
  },
  {
    icon: Eye,
...
const certifications = ["Licensed", "Bonded", "Insured", "BBB A+"];
        ...
        <div className="mb-20">
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Your security is our priority. Every technician is thoroughly vetted, trained, and committed to delivering exceptional service.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="font-mono text-sm text-muted-foreground">Years of trusted service</span>
              <div className="mt-8">
                <span className="text-7xl lg:text-8xl font-display">15+</span>
                <span className="block text-muted-foreground mt-2">Years serving the community</span>
              </div>
            </div>
