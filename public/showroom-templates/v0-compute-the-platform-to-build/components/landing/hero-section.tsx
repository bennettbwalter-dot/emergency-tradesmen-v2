...
const words = ["secure", "protect", "unlock", "install"];
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/images/locksmith-hero.jpg"
          alt=""
          aria-hidden="true"
          className="w-full h-full object-cover object-center opacity-80"
        />
        {/* Red accent overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-red-900/40 via-red-800/20 to-transparent mix-blend-multiply" />
        <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-red-500/10 to-red-600/30" />
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        <div className="mb-12">
          ...
          >
            <span className="block whitespace-nowrap">Your security,</span>
      ...
      >
        <div className="max-w-[1400px] mx-auto flex items-start gap-10 lg:gap-20">
          {[
            ...
            { value: "50k+", label: "locks serviced" },
          ].map((stat) => (
