...
const plans = [
  {
    name: "Residential",
    description: "For homeowners and renters",
  ...
  },
  {
    ...
    description: "For landlords and managers",
    price: { monthly: null, annual: null },
    features: [
      "Volume discounts",
    ...
    <section id="pricing" ref={sectionRef} className="relative py-32 lg:py-40">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20">
          <div className="lg:col-span-7">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
              ...
              Fair &
              <br />
              <span className="text-stroke">upfront.</span>
            </h2>
          </div>
          
          <div className="lg:col-span-5 relative p-0 h-96 lg:h-auto">
            {/* Premium lock image */}
            <div className={`absolute inset-0 pointer-events-none transition-all duration-1000 delay-100 overflow-hidden rounded-lg ${
              isVisible ? "opacity-100" : "opacity-0"
            }`}>
              <img
                src="/images/premium-lock.jpg"
                alt="Premium lock hardware"
                className="w-full h-full object-cover"
              />
              {/* Red accent overlay */}
              <div className="absolute inset-0 bg-gradient-to-br from-red-600/40 via-red-800/20 to-transparent mix-blend-multiply" />
              <div className="absolute inset-0 bg-gradient-to-tl from-red-700/30 via-transparent to-red-500/20" />
            </div>
        ...
        <div className={`mt-20 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 pt-12 border-t border-foreground/10 transition-all duration-1000 delay-500 ${
          ...
          <a href="tel:+1-555-LOCK" className="text-sm underline underline-offset-4 hover:text-foreground transition-colors">
            Call (555) LOCK-247
          </a>
        </div>
      </div>
