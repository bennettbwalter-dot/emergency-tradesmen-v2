...
const testimonials = [
  {
    quote: "Locked out at midnight and they were here in 12 minutes. Professional, courteous, and fair pricing. Highly recommend!",
    author: "Sarah Chen",
    role: "Homeowner",
    company: "Downtown Resident",
    metric: { value: "12min", label: "Response time" },
  },
  {
    quote: "They installed a complete smart lock system for our office. The team was knowledgeable and the work was impeccable.",
    author: "Marcus Webb",
    role: "Office Manager",
  ...
  {
    quote: "Lost my car keys at the worst time. They made a new transponder key on the spot. Saved my day!",
    author: "Elena Rodriguez",
    role: "Customer",
    company: "North Side",
    metric: { value: "Same", label: "Day service" },
  },
  {
    quote: "We use them for all our rental properties. Reliable, fair, and always available when we need them.",
    author: "James Liu",
    role: "Property Manager",
    company: "Liu Properties",
    metric: { value: "50+", label: "Properties served" },
  },
];
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              <span className="text-background/40"> of customers.</span>
            </h2>
          </div>
