...
const steps = [
  {
    ...
    title: "Call",
    subtitle: "us anytime",
    description: "Reach our 24/7 dispatch center. Describe your situation and location. We'll give you an upfront quote immediately.",
  },
  {
    number: "02",
    title: "We arrive",
    subtitle: "in minutes",
    description: "A certified locksmith is dispatched to your location. Average arrival time is 15-20 minutes across our service area.",
  },
  {
    number: "03",
    title: "Problem",
    subtitle: "solved",
    description: "Our technician assesses the situation, explains the solution, and gets to work. You're back to your day in no time.",
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Arrive.</span>
              <span className="block text-white/10">Solve.</span>
            </h2>
          </div>

          {/* Image key cutting — se colle en bas sur les blocs */}
          <div className={`relative h-[320px] lg:h-[640px] overflow-hidden transition-all duration-1000 delay-200 ${
            ...
            <img
              ...
              alt=""
              aria-hidden="true"
              className="absolute bottom-0 left-0 w-full h-full object-cover object-center rounded-lg"
            />
            {/* Red accent overlay */}
            <div className="absolute inset-0 bg-gradient-to-tl from-red-600/40 via-red-800/20 to-transparent mix-blend-multiply rounded-lg" />
            <div className="absolute inset-0 bg-gradient-to-br from-transparent via-red-500/10 to-red-700/30 rounded-lg" />
