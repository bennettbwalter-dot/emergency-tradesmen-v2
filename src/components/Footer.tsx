          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li><Link to={`${countryPrefix}/contact`} className="text-white/50 hover:text-white text-sm transition-all hover:translate-x-1 inline-block">Contact Support</Link></li>
              </ul>
