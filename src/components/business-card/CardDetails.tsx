    ...
    return (
        <div className="flex flex-col gap-2 w-full mt-2 font-ui">
            {details.map((item, i) => {
                ...
                return (
                    <div key={i} className="relative group flex items-center h-10 w-full px-4 rounded-full border border-white/5 bg-white/5 hover:bg-white/10 transition-colors">
                        <div className="w-6 flex justify-center shrink-0 mr-3">
