            ...
            <div className="relative z-10 w-full h-full flex items-center justify-center">
                ...
                {/* SVG created with Arrow, by QuiverAI (https://quiver.ai) - Modified for Red color scheme with Tool Icon */}
                  ...
                  <defs>
                    ...
                    <linearGradient id="paint9_linear_tool" x1="107" x2="148.7" y1="62.81" y2="137.3" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#96989B" offset="0"/>
                        <stop stop-color="#D9DBDD" offset=".5208"/>
                        <stop stop-color="#626365" offset="1"/>
                    </linearGradient>
                    <linearGradient id="paint10_linear_tool" x1="103.7" x2="103.7" y1="67.57" y2="75.76" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#96989B" offset="0"/>
                        <stop stop-color="#D9DBDD" offset=".5208"/>
                        <stop stop-color="#626365" offset="1"/>
                    </linearGradient>
                    <linearGradient id="paint11_linear_tool" x1="111.1" x2="111.1" y1="100.8" y2="136.8" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#96989B" offset="0"/>
                        <stop stop-color="#D9DBDD" offset=".5208"/>
                        <stop stop-color="#626365" offset="1"/>
                    </linearGradient>
