                        ...
                        {featuredPost && (
                            <div className="relative w-full overflow-visible md:overflow-hidden group">
                                ...
                                <div className="flex flex-col md:flex-row">
                                    ...
                                    {/* Content Section */}
                                    <div className="relative w-full md:w-[60%] md:min-h-[50vh] lg:min-h-[85vh] flex items-end md:items-center p-6 sm:p-10 md:p-12 lg:p-16 xl:p-24">
                                        <div className="max-w-2xl space-y-3 md:space-y-4 lg:space-y-6 animate-fade-up">
                                            ...
                                            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-display font-black leading-[1.1] text-foreground drop-shadow-lg text-balance">
                                            ...
                                            <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-full font-light leading-relaxed drop-shadow-md line-clamp-2 md:line-clamp-3">
                                                {featuredPost.excerpt}
                                            </p>

                                            <div className="flex items-center gap-4 pt-2 md:pt-4">
                                                <Button asChild size="lg" className="h-11 md:h-12 lg:h-14 px-5 md:px-6 lg:px-8 text-sm md:text-base lg:text-lg bg-white text-black hover:bg-gold hover:text-black border-none rounded-none transition-all font-bold tracking-tight">
