...
export default function AnalyticsPage() {
    ...
    async function loadAnalytics() {
        setLoading(true);
        try {
            const [metricsData, revenueData, churnData, activityData, trendsData] = await Promise.all([
                getSubscriptionMetrics(),
                getRevenueMetrics(),
                getChurnMetrics(),
    ...
    if (!metrics || !revenue || !churn) return null;
        ...
        <div className="p-8 space-y-8">
            ...
            <div>
                ...
                <p className="text-muted-foreground mt-2">
                    Real-time tracking of subscribers, revenue, and growth metrics
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <MetricCard
                    title="Churn Rate"
                    value={`${churn.monthlyChurnRate.toFixed(1)}%`}
                    change={churn.cancellationsThisMonth}
                    changeLabel="cancellations"
                    icon={UserMinus}
